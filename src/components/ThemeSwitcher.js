...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="dropdown dropdown-bottom dropdown-end z-50 content-center p-0">
      <label tabIndex={0} className=" dropdown dropdown-bottom dropdown-end z-50 btn pt-4">
        Theme
      </label>
      <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
        <li><button onClick={() => handleThemeChange('light')}>Light</button></li>
